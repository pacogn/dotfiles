...
command! LeaderMappingsDeclaration call fzf#run({'source': 'cd $DOTFILES/config/nvim/startup; sh '.utils#get_bin_directory().'/leader_mappings_declaration.sh', 'sink': function('Noop'), 'options': '--ansi'})
